    ...
    return(
        <section className="md:h-full flex items-center text-gray-700 lg:mt-24 sm:mt-32 mt-32 mb-24 ">
          <div className="container px-8 py-0 mx-auto">
             ...
             className="grid grid-cols-1  lg:grid-cols-3 sm:pl-32 lg:pl-20 pl-12 gap-8 justify-center items-center "
           
             >
                  <div 
                      
                  className="lg:w-[400px] w-[350px] cursor-pointer shadow-md p-6 rounded-lg border border-gray-500 hover:bg-slate-50 hover:transform hover:-translate-y-1  transition-transform duration-300"  
                  ...
                  <div className="  lg:w-[400px] w-[350px] cursor-pointer shadow-md p-6 lg:-ml-4 rounded-md border border-gray-500 hover:bg-slate-50 hover:transform hover:-translate-y-1  transition-transform duration-300" >
                  <div className="flex flex-row gap-4">
                     <div className=" h-14 w-14  border border-gray-500 rounded-full inline-back p-4  mb-3">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                  ...
                  <div className="  lg:w-[400px] w-[350px] curso shadow-md p-6 lg:-ml-8 rounded-md border border-gray-500 hover:bg-slate-50 hover:transform hover:-translate-y-1  transition-transform duration-300">
                  <div className="flex flex-row gap-4">
                    <div className="h-14 w-14  border border-gray-500 rounded-full inline-back p-4  mb-3">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
